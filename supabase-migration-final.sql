-- MetalUnion Database Migration Script for Supabase (Final Clean Version)
-- This script creates all tables with proper UUID types and fixes all RLS policy issues
