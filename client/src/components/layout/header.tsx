          ...
          <div className="flex items-center space-x-6">
            <form onSubmit={handleSearch} className="relative hidden md:block group">
              <Input
                ...
                className="bg-black/50 border-2 border-metal-gray text-white placeholder-white focus:border-metal-red focus:shadow-lg focus:shadow-metal-red/30 w-72 pl-12 h-12 font-bold uppercase tracking-wider transition-all duration-300 group-hover:border-metal-red/50"
