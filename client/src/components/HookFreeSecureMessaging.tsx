...
export function HookFreeSecureMessagingComponent({ userId = 'demo-user' }: HookFreeSecureMessagingProps) {
  // Create a simple messaging component using direct HTML
  const conversations = [
    {
      id: 'conv1',
      participantName: 'MetalFan2024',
      ...
      <div className="flex flex-col h-full max-h-[80vh]">
        ...
        <div className="flex flex-1 overflow-hidden">
            ...
            <div className="p-4">
              ...
              <div className="space-y-2">
                {conversations.map((conv) => (
                  <div
                    key={conv.id}
                    className="w-full text-left p-3 rounded-lg border bg-red-600/20 border-red-500/50"
                  >
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="p-4 border-b border-red-900/30 bg-black/30">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <span className="text-white font-medium">{selectedConv.participantName}</span>
                    <div className="flex items-center space-x-2 text-sm">
                      <div className={`h-2 w-2 rounded-full ${
                        selectedConv.participantStatus === 'online' ? 'bg-green-500' : 'bg-gray-500'
                      }`}></div>
                      <span className="text-gray-400 capitalize">{selectedConv.participantStatus}</span>
                    </div>
                  </div>
                </div>
            ...
            {/* Messages */}
            <div className="flex-1 p-4 overflow-y-auto space-y-4 bg-gradient-to-b from-black/10 to-black/20" style={{maxHeight: '400px'}}>
